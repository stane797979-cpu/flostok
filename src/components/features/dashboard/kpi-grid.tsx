...
import { KpiDrilldownDialog } from "@/app/dashboard/kpi/_components/kpi-drilldown-dialog";
...
import type { KPIDrilldownType } from "@/server/actions/kpi";
...
function getKPIStatus(
  ...
  const ratio = lowerIsBetter ? target / Math.max(value, 0.01) : value / target;
...
export function KPIGrid({ metrics, trends, targets }: KPIGridProps) {
  ...
  const openDrilldown = (type: KPIDrilldownType) => {
        ...
        <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <KPICard
              ...
              iconName="bar-chart"
              onClick={() => openDrilldown("turnover")}
            />
            <KPICard
              name="평균 재고일수"
            ...
            <KPICard
              ...
              iconName="alert"
              onClick={() => openDrilldown("stockout")}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <KPICard
              ...
              onClick={() => openDrilldown("leadtime")}
            />
            <KPICard
              name="평균 리드타임"
            ...
            <KPICard
              ...
              iconName="check-circle"
              onClick={() => openDrilldown("fulfillment")}
            />
          </div>
        </div>
